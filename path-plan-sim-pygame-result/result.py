...
class Result_Demo:
    ...
    def compute_smoothness(self):
        ...
        if self.smoothness=="Nan":
            self.smoothness=0
        return self.smoothness

    # 曲率绘图基于路径
    def draw_curvature_set(self):
        figure = plt.figure()
        path_x = [x for (x, y) in self.track]
        path_y = [y for (x, y) in self.track]
        curvature = self.compute_curvature(path_x, path_y)

        plt.plot(path_x[1:], curvature, marker='o', color='r')
    ...
    def calculate_path_length(self):
        ...
        self.pathlen=round(self.pathlen,4)
...
class Category_Demo:
    ...
    def calculate_average_smoothness(self):
        ...
        self.ave_smooth = round(self.ave_smooth, 4)
    ...
    def calculate_average_length(self):
        ...
        self.ave_path_length=round(self.ave_path_length,4)
    ...
    def calculate_average_time(self):
        ...
        self.ave_time=round(self.ave_time,4)
